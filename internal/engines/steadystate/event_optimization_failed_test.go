...
func TestRecordOptimizationFailedEvent(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			engine := NewEngine(k8sClient, k8sClient, scheme, fakeRecorder, sourceRegistry, testConfig, allocation.NewNoOpLimiter("test"))
...
func TestRecordOptimizationFailedEvent_NilRecorder(t *testing.T) {
	...
	engine := NewEngine(k8sClient, k8sClient, scheme, nil, sourceRegistry, testConfig, allocation.NewNoOpLimiter("test"))
